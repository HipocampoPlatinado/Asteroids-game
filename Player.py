...
class Player(CircleShape):
    ...
    def shoot(self):
        ...
        rotated_velocity = bullet.velocity.rotate(self.rotation)
        speeded_up_rotated_velocity = rotated_velocity * PLAYER_SHOOT_SPEED
        bullet.velocity = speeded_up_rotated_velocity
